...
loader.load("https://cdn.jsdelivr.net/gh/micaparat/mic-server/ambulanta-moto/model/room.json", function (obj) 
    {
        // Add the loaded object to the scene
        scene.add(obj);
    },    
);
glbLoader.load("https://cdn.jsdelivr.net/gh/micaparat/mic-server/ambulanta-moto/model/bike.glb", function (gltf) 
    {
        // Add the loaded object to the scene
...
loader.load("https://cdn.jsdelivr.net/gh/micaparat/mic-server/ambulanta-moto/model/bike-parts.json", function (obj) 
    {
        // Add the loaded object to the scene
        scene.add(obj);
    },    
);
loader.load("https://cdn.jsdelivr.net/gh/micaparat/mic-server/ambulanta-moto/model/objects.json", function (obj) 
    {
        // Add the loaded object to the scene
        scene.add(obj);
    },    
);
loader.load("https://cdn.jsdelivr.net/gh/micaparat/mic-server/ambulanta-moto/model/bike-models.json", function (obj) 
    {
        // Add the loaded object to the scene
        scene.add(obj);
    },    
...
calendarTextLoader.load('https://cdn.jsdelivr.net/gh/micaparat/mic-server/ambulanta-moto/fonts/bebas-neue-r.json', function (font) {
